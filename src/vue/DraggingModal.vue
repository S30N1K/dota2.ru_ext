<template>
	<Teleport to="body">
		<transition name="fw-fade">
			...
			>
				<header class="fw-header" @mousedown="onDragStart" @touchstart.prevent="onTouchStart">
					<div class="fw-title"><slot name="title">Окно</slot></div>
					<div class="fw-buttons"><slot name="buttons"></slot></div>
				</header>
