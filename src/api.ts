 ...
 */
export async function getIgnoreList(): Promise<void> {
    // const html = await parseText("/forum/settings/ignorelist/");
    // const doc = new DOMParser().parseFromString(html, "text/html");
    // console.log(doc);
    throw new Error("Функция getIgnoreList не реализована");
}
